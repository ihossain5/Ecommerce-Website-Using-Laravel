              ...
              <div class="card mb-6">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group"> 
                      ...
                      <input type="text" name="price" class="form-control @error('price') is-invalid @enderror" id="name" aria-describedby=""
                      value="{{$product->price}}">
                            @error('price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group">
                      <div class="custom-file"> 
                        ...
                        <center>
                          <img src="{{asset('/storage/products/'.$product->image)}}" alt="image" height="" width="50">
                        </center>
                         @error('image')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
